            ...
            <div className="bg-white p-6 md:p-12 shadow-2xl border border-slate-100 min-w-[700px] lg:min-w-0 w-full max-w-4xl mx-auto print:shadow-none print:border-none print:m-0 print:p-0 print:w-full print:max-w-none text-slate-800 font-sans" style={{ height: 'auto', minHeight: 'auto' } as React.CSSProperties}>
                ...
                <div className="flex justify-between items-end pt-12 border-t-2 border-slate-900">
                    <div>
                        ...
                        <p className="text-xs font-bold text-slate-900">{quotation.createdBy}</p>
                    </div>
                    <div className="text-right">
                        <div className="mb-2">
                            <img src="/signature.png" alt="Signature" className="h-10 ml-auto opacity-80" />
                        </div>
                        <p className="text-xs font-black text-slate-900 uppercase tracking-tighter">Authorized Signatory</p>
                    </div>
                </div>
